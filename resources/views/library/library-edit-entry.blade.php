                    ...
                    <div class="card-body" style="display: flex; justify-content: center;">
                        ...
                        @foreach($data as $d)
                        	<table style="align-self: center; table-layout: inherit;">
                                ...
                                <tr>
                                    <td><input class="form-control" style="width: 200px;" type="text" name="doctypeabbv" id="doctypeabbv" required placeholder="Abbreviation" value="{{$d->doc_lib_abbrv}}"></td>
                                </tr>
                                <tr>
                                    <td><input class="form-control" style="width: 200px;" type="text" name="doctypefull" id="doctypefull"  required placeholder="Full Description" value="{{$d->doc_full_desc}}"></td>
                                </tr>
                                <tr>
...
<script>
    $(document).on("click", ".btn-save", function(e) {
        ...
        $.ajax({
                url: "{{ url('/library/library/update-entry') }}/"+val,
                type: "POST",
                ...
                success: function(response){
                    ...
                    //$('#doc-ff').modal('hide');
                    window.location.href="{{ url('/library/library') }}";
                  },
                  error: function(ex){
