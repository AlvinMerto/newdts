                    ...
                    <div class="card-body" style="display: flex; justify-content: center;">
                        ...
                        <!--Content-->
                        	<table style="align-self: center; table-layout: inherit;">
                        		<tr>
                        			<td align="center" class="card-header" style="padding: 10px; color: #fff; font-weight: bold; font-size: 13px !important; background: #585858; border-top: 1px solid #0040FF; border-bottom: 1px solid #0040FF;">NEW LIBRARY ENTRY</td>
                        		</tr>
                                {{--<tr>
                                    <td><input class="form-control" style="width: 200px;" type="text" name="doctypeabbv" id="doctypeabbv" value="" required placeholder="Abbreviation"></td>
                                </tr>--}}
                                <tr>
                                    <td><input class="form-control" style="width: 400px;" type="text" name="doctypefull" id="doctypefull" value="" required placeholder="Category Name"></td>
                                </tr>
                                <tr>
...
<script>
    $(document).on("click", ".btn-save", function(e) {
        ...
        $.ajax({
                url: "{{ url('/library/library/save-entry') }}/",
                type: "POST",
