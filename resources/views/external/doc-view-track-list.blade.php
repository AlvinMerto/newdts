                                ...
                                @endif
                                    ...
                                    @if($d->confi_name == Auth::user()->f_name && $d->classification == 1)
                                        ...
                                        <tr class="border_bottom">
                                            ...
                                            <td align="center" class="card-header" style="padding: 10px; color: #0B4C5F; font-weight: bold; font-size: 13px !important;">Agency/Office</td>
                                        ...
                                        <tr class="border_bottom">
                                            <td align="center" class="card-header" style="padding: 10px; color: #0B4C5F; font-weight: bold; font-size: 13px !important;">File Type</td>
                                            <td colspan="3" align="left" >{{$d->type}}</td>
                                            {{--<td align="center" class="card-header" style="padding: 10px; color: #0B4C5F; font-weight: bold; font-size: 13px !important;">Signatory</td>
                                            <td align="left" >{{$d->signatory}}</td>--}}
                                        </tr>

                                        <tr class="border_bottom">
                                            <td align="center" class="card-header" style="padding: 10px; color: #0B4C5F; font-weight: bold; font-size: 13px !important;">Document Category/Type</td>
                                    ...
                                    @elseif(Auth::user()->access_level != 5 && $d->confi_name != Auth::user()->f_name && $d->classification != 1)
                                       ...
                                       @if($data->count()>0)
                                        ...
                                        {{--
                                        <tr>
                                                <td><a href="{{ url('/external-document-new-entry') }}" style="font-size: 12px;" class="btn btn-medium btn-success"><i class="fa fa-edit"></i> New External Entry</a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5">
                                            ...
                                            <button onclick="generateAcknowledgement();" class="btnAcknowledge btn btn-medium btn-info" style="font-size: 12px; float: left; margin-left: 10px;"><i class="fa fa-file-pdf-o" id="{{$d->id}}"></i> Acknowledgement Receipt</button>

                                            <a href="{{ url('/external-document-new-entry') }}" style="font-size: 12px; float: right;" class="btn btn-medium btn-success"><i class="fa fa-edit"></i> New External Entry</a>
                                        ...
                                        <button id="{{$d->ref_id}}" class="btn-ff btn btn-danger pl-3 pr-3" style="font-size: 12px; float: right; margin-right: 10px;"><span class="fa fa-exclamation-triangle" aria-hidden="true"></span> Action</button>
                                                ...
                                                <a href="{{url('/external-document-list-view')}}" style="font-size: 12px; float: right; margin-right: 10px;" class="btn btn-medium btn-info"><i class="fa fa-chevron-left"></i> Back</a>
                                        </td>
                                    ...
                                    @else
                                        <td colspan="5">
                                            ...
                                            <a href="{{ url('/external-document-new-entry') }}" style="font-size: 12px; float: right;" class="btn btn-medium btn-success"><i class="fa fa-edit"></i> New External Entry</a></td>
                                    @endif
...
<script>
    ...
    function generateAcknowledgement() {
        ...
        window.location = "{{ url('/acknowledment-receipt') }}/"+val_id;

        //alert(val_id);
        /*
            $.ajax({
                url: "{{url('/acknowledment-receipt')}}/"+val_id,
                type: "GET",
                ...
                success: function(response){
                    ...
                    swal({
                              position: 'center',
                              icon: 'info',
                              title: 'Acknowledgement receipt generated successfully',
                              showConfirmButton: false,
                              timer: 1500
                            });
                ...
                error: function(ex){
                    ...
                    swal({
                              position: 'center',
                              icon: 'error',
                              title: 'Failed to find data to generate acknowledgement receipt.',
                              showConfirmButton: false,
                              timer: 1500
                            });
                }
