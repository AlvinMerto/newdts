...
<div class="content-wrapper ml-2" style="width: 115%">
    <div class="row justify-content-center" style="width: 100%">
        <div class="col-md-8" style="width: 100%">
            <div class="card mt-3">
                <div class="card-header bg-success" style="font-size: 16px; font-weight: bold; color: #fff;">External Document Lists</div>
                                    ...
                                    <tr>
                                        <td class="d-flex">
                                              <div class="sidebar-form" style="width: 200px; margin-left: 5px;">
                                                ...
                                                <div class="sidebar-form" style="width: 200px; margin-left: 5px;">
                                                    <div class="input-group">
                                                        <input list="typelists" placeholder="Filter by Type" name="ff_type" id="ff_type" class="form-control">
                                                        <span class="input-group-btn">
                        ...
                        <!--Content-->
                            ...
                            <table style="align-self: center; table-layout: inherit;">
                                <tr class="border_bottom">
                                    ...
                                    >Description</td>
                                    <td align="center" style="padding: 10px; background-color: #3b5998; color: #fafafa; font-weight: bold;">Agency/Office</td>
                                    <td align="center" style="padding: 10px; background-color: #3b5998; color: #fafafa; font-weight: bold;">File Type</td>
                                    ...
                                    <td colspan="2" align="center" style="padding: 10px; background-color: #3b5998; color: #fafafa; font-weight: bold;">Action</td>
                                </tr>
                                ...
                                @elseif($d->classification==2)
                                    ...
                                    <td align="center" style="color: #fe2712; font-weight: bold;">{{$d->type}}</td>
                                ...
                                @elseif($d->classification==3)
                                    ...
                                    <td align="center" style="color: #ff8000; font-weight: bold;">{{$d->type}}</td>
                                ...
                                @elseif($d->classification==4)
                                    ...
                                    <td align="center" style="color: #0247fe; font-weight: bold;">{{$d->type}}</td>
                                ...
                                @endif
                                    ...
                                    <td align="center" style="color: #ff8000; font-weight: bold;">
                                        <a href="{{url('/external-document-track-list-view/view-document-tracking')}}/{{$d->ref_id}}" id="{{$d->id}}" class="btn btn-primary pl-4 pr-4"><span class="fa fa-envelope-open-o" aria-hidden="true"></span> View</a>
                                ...
                                @elseif($d->classification==3)
                                    ...
                                    <td align="center" style="color: #ff0000; font-weight: bold;">{{$d->type}}</td>
                                ...
                                @if($d->classification==1)
                                    ...
                                    @elseif($d->stat=='approve')
                                        ...
                                        <td align="center" style="color: #088A08; font-weight: bold;">{{$d->type}}</td>
                                    ...
                                    @elseif($d->stat=='disapprove')
                                        ...
                                        <td align="center" style="color: #DF0101; font-weight: bold;">{{$d->type}}</td>
      ...
      <span id="form_result"></span>
            <table width="100%">
                ...
                <tr id="busywait" style="display: none;">
                    <td colspan="2" align="center"><span style="color: #3A01DF;"><img src="{{ url('/images/busy_wait.gif') }}"height="80px">
  ...
  <div class="modal-dialog  modal-lg" style="min-width: auto; max-width: 50%"  role="document">
    <div class="modal-content">
      ...
      <table border="1px #fff solid;" style="align-self: center;">
        ...
        <tr>
            <td><span style="margin-left: 30px;">Receiver's Email</span></td>
    ...
    $(document).on("click", ".go_btn", function(e) {
        ...
        if(dept.length === 0){
            ...
            $.ajax({
                ...
                type: "POST",
                data: {_token: CSRF_TOKEN,_id: x_id,remarks: rem, division: dept, for_appro_action: faction, for_info:finfo, for_guidance:fguidance, for_reference:freference, for_review:freview,for_signature:fsignature},
        ...
        $(document).on("click", ".btn_save", function(e) {
            ...
            if (document.getElementById('chkdocreturn').checked) {
             ...
             $.ajax({
                ...
                type: "POST",
                data: {_token: CSRF_TOKEN,_id: x_id, _docdate: docdate, _barcode: barcode, _agency: agency, _signature: signature,_sigemail: r_email, _doctitle: doctitle,_desc: desc,_briefer: briefer, _ncopy: ncopy,_npages:npages, returndoc:retdoc, _doctype: doctype},
