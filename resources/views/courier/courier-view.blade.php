                        ...
                        <!--Content-->
                        	<table style="align-self: center; table-layout: inherit;">
                        		{{--<tr>
                        			...
                        			<td align="center" class="card-header" style="padding: 10px; color: #fff; font-weight: bold; font-size: 13px !important; background: #585858; border-top: 1px solid #0040FF; border-bottom: 1px solid #0040FF;">LIST</td>
                        		...
                        		@foreach($data as $d)
                        		<tr>
                        			{{--<td align="center" class="card-header" style="padding: 10px; color: #0B4C5F; font-weight: bold; font-size: 13px !important;">{{$d->courier_abbv}}</td>--}}
                        			<td align="center" class="card-header" style="padding: 10px; color: #0B4C5F; font-weight: bold; font-size: 13px !important;">{{$d->courier_desc}}</td>
                        			<td align="center" class="card-header" style="padding: 10px; color: #0B4C5F; font-weight: bold; font-size: 13px !important;">
                        				...
                        				<br>
                        				<a href="{{url('/courier/library/remove-entry')}}/{{$d->id}}" id="{{$d->id}}" onclick="return confirm('Are you sure?')" class="btn btn-small btn-danger mt-2  pl-3 pr-3"><span class="fa fa-trash" aria-hidden="true"></span> Delete </a>
                        			</td>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", ".btn-edit", function() {
            ...
            window.location.href="{{ url('/courier/library/edit-entry') }}/"+x_id;
        });  
        ...
        $(document).on("click", ".delete-btn", function() {
             ...
             if (confirm("Press a button!")) {
                window.location.href="{{ url('/courier/library/remove-entry') }}/"+x_id;
              } 
