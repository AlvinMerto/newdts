                ...
                <div class="card-header bg-primary" style="font-size: 16px; font-weight: bold; color: #fff;">{{Auth::user()->f_name}}'s Profile</div>
                    <div class="card-body" style="display: flex; justify-content: center;">
                        ...
                        <section style="width: 100%">
                            ...
                            <table>
                                <tr>
                                    <td colspan="2" align="left"><img src="{{ url('public/dist/profile')}}/{{Auth::user()->profile_img }}" class="user-image" alt="User Image" height="200" width="auto"><br><span class="btn-edit-profile btn btn-success btn-flat mt-2">Edit Profile</span> <span class="btn-profile btn btn-default btn-flat mt-2">Upload Profile Picture</span></td>
                                </tr>
                                <tr>
                                    <td>Username</td>
                                    <td>{{$d->name}}</td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".btn-edit-profile", function() {
            ...
            window.location = '/setting/my-account/update/'+user_id;
        });
