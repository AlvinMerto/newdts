    ...
    <div class="row justify-content-center" style="width: 100%">
    					...
    					<!--Content-->
    						...
    						<table style="align-self: center; width: 100%;">
                                <tr class="border_bottom">
                                    ...
                                    >Description</td>
                                    <td align="center" style="padding: 10px; background-color: #3b5998; color: #fafafa; font-weight: bold;">From/Addressee</td>
                                    <td align="center" style="padding: 10px; background-color: #3b5998; color: #fafafa; font-weight: bold;">To/Receiver</td>
                                    ...
                                    @if($d->actioned == 0)
                                        @if($d->classification == 1 && $d->confi_name == Auth::user()->f_name)
                                             @if($d->days_count>5)
                                                ...
                                                <td align="center" style="background: #F4A8A9; color: #434243; font-weight: bold;">{{$d->sendto}}</td>
       ...
       class="rem-tooltip" data-html="true">{{$d->status}}</a></td>
                                             ...
                                             @else
                                                ...
                                                <td align="center" style="color: #FE0001; font-weight: bold;">{{$d->sendto}}</td>
       ...
       class="rem-tooltip" data-html="true">{{$d->status}}</a></td>
                                            ...
                                            @else
                                                ...
                                                <td align="center" style="color: #045FB4; font-weight: bold;">{{$d->sendto}}</td>
       ...
       class="rem-tooltip" data-html="true">{{$d->status}}</a></td>
                                        ...
                                        @elseif($d->classification == 1 && $d->confi_name != Auth::user()->f_name)
                                            ...
                                            @else
                                                ...
                                                <td align="center" style="color: #DF013A; font-weight: bold;">{{$d->sendto}}</td>
       ...
       class="rem-tooltip" data-html="true">{{$d->status}}</a></td>
                                            ...
                                            @else
                                                ...
                                                <td align="center" style="color: #B505AE; font-weight: bold;">{{$d->sendto}}</td>
       ...
       class="rem-tooltip" data-html="true">{{$d->status}}</a></td>
                                            ...
                                            @else
                                                ...
                                                <td align="center" style="color: #0A610A; font-weight: bold;">{{$d->sendto}}</td>
                                    ...
                                    @else
                                        ...
                                        @if($d->classification == 1 && $d->confi_name == Auth::user()->f_name)
                                            @if($d->days_count>5)
                                                ...
                                                <td align="center" style="background: #F4A8A9; color: #434243; font-weight: normal;">{{$d->sendto}}</td>
       ...
       class="rem-tooltip" data-html="true">{{$d->status}}</a></td>
                                            ...
                                            @else
                                                ...
                                                <td align="center" style="color: #045FB4; font-weight: normal;">{{$d->sendto}}</td>
       ...
       class="rem-tooltip" data-html="true">{{$d->status}}</a>
                                            ...
                                            @else
                                                ...
                                                <td align="center" style="color: #DF013A; font-weight: normal;">{{$d->sendto}}</td>
       ...
       class="rem-tooltip" data-html="true">{{$d->status}}</a></td>
                                            ...
                                            @else
                                                ...
                                                <td align="center" style="color: #B505AE; font-weight: normal;">{{$d->sendto}}</td>
       ...
       class="rem-tooltip" data-html="true">{{$d->status}}</a></td>
                                            ...
                                            @else
                                                ...
                                                <td align="center" style="color: #0A610A; font-weight: normal;">{{$d->sendto}}</td>
                                    ...
                                    @if($d->days_count>5)
                                        <td align="center" style="background: #F4A8A9;">
                                            @if($d->confi_name == Auth::user()->f_name && $d->classification == 1 || $d->classification == 1 && Auth::user()->access_level==5)
                                                <a href="{{url('/outgoing-document-track-list-view/view-document-tracking')}}/{{$d->ref_id}}" id="{{$d->id}}" class="btn btn-success pl-4 pr-4"><span class="fa fa-envelope-open-o" aria-hidden="true"></span> View</a>
