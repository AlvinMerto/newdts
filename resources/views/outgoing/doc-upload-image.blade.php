...
<div class="content-wrapper ml-2" style="width: auto;">
    <div class="row justify-content-center" style="width: 100%">
        <div class="col-md-8">
            <div class="card mt-3">
                <div class="card-header bg-danger" style="font-size: 16px; font-weight: bold; color: #fff;"><span class="fa fa-paperclip"></span>  Attach Files</div>
                        ...
                        <!--Content-->
                            <table style="align-self: center; table-layout: inherit;">
                                ...
                                <tr>
                                            ...
                                            <td colspan="2" align="center" style="padding: 10px; background-color: #3b5998; color: #fafafa; font-weight: bold;">Signatory</td>
                                            <td colspan="2" align="center" style="padding: 10px; background-color: #3b5998; color: #fafafa; font-weight: bold;">To</td>
                                        </tr>
                                        <tr class="border_bottom">
                                            <td align="center" >{{$d->briefer_number}}</td>
                                            <td colspan="2" align="center" >{{$d->type}}</td>
                                            <td colspan="2" align="center" >{{$d->signatory}}</td>
                                            <td colspan="2" align="center" >{{$d->sendto}}</td>
                                        </tr>
                                <tr>
                                    <td colspan="7">
                                        <form method="POST" action="{{ url('/outgoing-document-new-entry/save-image')}}/{{$d->id}}" accept-charset="utf-8" enctype="multipart/form-data">
                                        @csrf
                                    ...
                                    <td colspan="7"><a href="{{url('/outgoing-document-list-view')}}" class="btn_OK btn btn-success" style="padding-left: 20px; padding-right: 20px; float: right; float: right;"><span class="fa fa-check-square-o" aria-hidden="true"></span> Done</a></td>
                                </tr>
                            </table>
                                ...
                                <ul class="photos-gallery-layout">
                                     <li class="photos-gallery-li">
                                        <div class="photo">
                                            ...
                                            <a href="{{ url('/outgoing-document/remove-image')}}/{{$img->id}}/{{$img->ref_id}}/{{$img->img_file}}" style="float: right;">
