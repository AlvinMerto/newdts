    					...
    					<!--Content-->
    						...
    						<table style="align-self: center; table-layout: inherit;">
                                ...
                                @elseif($d->classification==3)
                                    ...
                                    <td align="center" style="color: #ff8000; font-weight: bold;">{{$d->days_count}}</td>
                                    <td align="center" style="color: #FE8100; font-weight: bold;">Moderate Priority</td>
                                ...
                                @else
                                    ...
                                    <td align="center" style="color: #ff8000; font-weight: bold;">{{$d->stat}}</td>
                                    <td align="center" style="color: #ff8000; font-weight: bold;">{{$d->days_count}}</td>
                                    <td align="center" style="color: #0A2061; font-weight: bold;">Undefined</td>
                                @endif
                                   <td align="center" >
                                        @if($d->confi_name == Auth::user()->f_name && $d->classification == 1 || $d->classification == 1 && Auth::user()->access_level==5)
                                            <a href="{{url('/internal-document-track-list-view/view-document-tracking')}}/{{$d->ref_id}}" id="{{$d->id}}" class="btn btn-primary pl-4 pr-4"><span class="fa fa-envelope-open-o" aria-hidden="true"></span> View</a>
                                ...
                                @elseif($d->classification==2)
                                    ...
                                    @elseif($d->stat=='disapprove')
                                        ...
                                        <td align="center" style="color: #0A2061; font-weight: bold;">Undefined</td>
                                    @else
                                        <td align="center"style="color: #fe2712;">{{date('M d, Y', strtotime($d->doc_receive))}}</td>
                                        <td align="center" style="color: #fe2712;">{{$d->barcode}}</td>
                                        <td align="left" style="white-space: pre-wrap;color: #fe2712;">{{$d->doctitle}}</td>
                                        <td align="left" style="white-space: pre-wrap;color: #fe2712;">{{ $d->description }}</td>
                                        <td align="center" style="color: #fe2712;">{{$d->agency}}</td>
                                        <td align="center" style="color: #fe2712;">{{$d->stat}}</td>
                                        <td align="center" style="color: #fe2712;">{{$d->days_count}}</td>
                                        <td align="center" style="color: #fe2712;">High Priority</td>
                                    @endif
                                @elseif($d->classification==3)
                                    @if($d->stat=='pending')
                                        <td align="center" style="color: #ff8000; font-weight: bold;">{{date('M d, Y', strtotime($d->doc_receive))}}</td>
