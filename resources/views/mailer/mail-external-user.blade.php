						...
						<tr>
							...
							<td style='padding:15px;'>
								<p style="background: #79dfea;float: left;padding: 10px;">
									...
									<a href="http://office.minda.gov.ph:9004/external-document-track-list-view/view-document-tracking/<?php echo $theid."/?i=".$itemid; ?>" style="text-decoration: none;color: #fff;font-size: 16px;"> View document </a>
								</p>
							</td>
						</tr>
					</table>
